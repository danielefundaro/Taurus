...
| `event-preparation` | [Preparazione operativa dell'evento](event-preparation-spec.md) | feature | draft | in-progress | BE, FE | [1](#event-preparation-evidenze) | [2](#event-preparation-evidenze) | non rilasciata | 2026-09-05 |
| `external-calendar-feed` | [Feed calendario esterno in sola lettura](external-calendar-feed-spec.md) | feature | approved | in-progress | BE, FE | [2](#external-calendar-feed-evidenze) | [4](#external-calendar-feed-evidenze) | non rilasciata | 2026-09-06 |
...
| `inventory-qr-code` | [QR code ed etichette per l'inventario](inventory-qr-code-spec.md) | feature | approved | implemented | BE, FE | [1](#inventory-qr-code-evidenze) | [3](#inventory-qr-code-evidenze) | non rilasciata | 2026-09-06 |
...
| `notification-delivery-generalization` | [Generalizzazione della consegna delle notifiche interne](notification-delivery-generalization-spec.md) | platform | approved | in-progress | BE, FE | [1](#notification-delivery-generalization-evidenze) | [1](#notification-delivery-generalization-evidenze) | non rilasciata | 2026-09-06 |
...
| `notification-preferences` | [Preferenze notifiche granulari](notification-preferences-spec.md) | feature | approved | in-progress | BE, FE | [2](#notification-preferences-evidenze) | [8](#notification-preferences-evidenze) | non rilasciata | 2026-09-06 |
...
| `tenant-onboarding-import` | [Onboarding guidato e importazione iniziale del tenant](tenant-onboarding-import-spec.md) | feature | approved | in-progress | BE, FE | [1](#tenant-onboarding-import-evidenze) | [5](#tenant-onboarding-import-evidenze) | non rilasciata | 2026-09-05 |
| `web-push-reminders` | [Promemoria eventi tramite Web Push](web-push-reminders-spec.md) | feature | approved | in-progress | BE, FE | [2](#web-push-reminders-evidenze) | [2](#web-push-reminders-evidenze) | non rilasciata | 2026-09-06 |
...
- Implementazione: [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/eventpreparation/EventPreparationService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/eventpreparation/EventPreparationService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/EventPreparationResource.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/EventPreparationResource.java), [`taurus-fe/src/app/pages/calendar-events/detail/detail.component.ts`](../taurus-fe/src/app/pages/calendar-events/detail/detail.component.ts)
...
- Test: [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/eventpreparation/EventPreparationServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/eventpreparation/EventPreparationServiceTest.java), [`taurus-fe/src/app/service/event-preparation.service.spec.ts`](../taurus-fe/src/app/service/event-preparation.service.spec.ts)
- Note: Incremento verticale in corso: migration inclusa nel master tenant e verificata dal plugin Liquibase; sono implementati workspace amministrativo, profili, valutazione derivata, programma, materiali e conferme a snapshot. Restano da completare viste personali/archivista/tesoriere, selettori frontend, notifiche e dashboard prima dello stato implemented.

<a id="external-calendar-feed-evidenze"></a>
### Feed calendario esterno in sola lettura

- Implementazione: [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/CalendarSubscriptionResource.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/CalendarSubscriptionResource.java), [`taurus-fe/src/app/components/calendar-feed-panel/calendar-feed-panel.component.ts`](../taurus-fe/src/app/components/calendar-feed-panel/calendar-feed-panel.component.ts)
- Migrazioni: [`taurus-be/src/main/resources/config/liquibase/changelog/20260905020000_calendar_feed_registry.xml`](../taurus-be/src/main/resources/config/liquibase/changelog/20260905020000_calendar_feed_registry.xml), [`taurus-be/src/main/resources/config/liquibase/changelog/20260905020001_external_calendar_feed.xml`](../taurus-be/src/main/resources/config/liquibase/changelog/20260905020001_external_calendar_feed.xml)
- Test: [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/CalendarFeedTokenServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/CalendarFeedTokenServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/IcalendarRendererTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/IcalendarRendererTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/CalendarFeedMigrationIT.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/calendarfeed/CalendarFeedMigrationIT.java), [`taurus-fe/src/app/service/calendar-feed.service.spec.ts`](../taurus-fe/src/app/service/calendar-feed.service.spec.ts)
- Note: Implementazione principale presente, ma restano da completare l'idempotenza di creazione e rotazione tramite idempotencyKey, la soglia anti-abuso globale/IP e le verifiche di isolamento tenant, redazione infrastrutturale del token e compatibilità con i client calendario previste dalla specifica.
...
- Implementazione: [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryQrCodeService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryQrCodeService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryLabelService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryLabelService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryScanService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryScanService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryIssueService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/impl/InventoryIssueService.java), [`taurus-fe/src/app/pages/inventory/scan/inventory-scan.component.ts`](../taurus-fe/src/app/pages/inventory/scan/inventory-scan.component.ts), [`taurus-fe/src/app/components/inventory-issue-list/inventory-issue-list.component.ts`](../taurus-fe/src/app/components/inventory-issue-list/inventory-issue-list.component.ts)
...
- Note: Implementazione verificata con test unitari, build Angular e applicazione Liquibase su PostgreSQL 17. Prima del rilascio resta la validazione fisica delle etichette su stampanti e dispositivi reali prevista dalla specifica.
...
- Note: La pipeline di consegna è presente, ma le notifiche di sorgente CALENDAR producono ancora il targetPath /calendar-events anziché la rotta applicativa /calendar; il click conduce quindi a una destinazione inesistente.
...
- Test: [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPreferencesServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPreferencesServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPreferenceResolverTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPreferenceResolverTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPushDeliveryServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationPushDeliveryServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationDeliveryAdminServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/NotificationDeliveryAdminServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/notification/NotificationTimingTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/notification/NotificationTimingTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/impl/NotificationPreferencesIT.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/impl/NotificationPreferencesIT.java), [`taurus-fe/src/app/service/notification-delivery-admin.service.spec.ts`](../taurus-fe/src/app/service/notification-delivery-admin.service.spec.ts), [`taurus-fe/src/app/pages/dashboard/components/notifications-widget/notification-widget.component.spec.ts`](../taurus-fe/src/app/pages/dashboard/components/notifications-widget/notification-widget.component.spec.ts)
- Note: Fasi 1-5 sostanzialmente presenti: profilo tipizzato, categorie e snooze, push immediati, silenzioso e digest, console amministrativa con retry e chiusura tecnica. Resta da completare la presentazione dello stato SKIPPED, attualmente mostrato come Stato sconosciuto. Restano inoltre attive per scelta le compatibilità della fase contract: doppia lettura della chiave legacy defaultReminderMinutes e booleano push_reminders.sent, da rimuovere dopo un rilascio compatibile.
...
- Implementazione: [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/OnboardingResource.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/web/rest/OnboardingResource.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingImportService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingImportService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingValidationService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingValidationService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingDomainApplicationService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingDomainApplicationService.java), [`taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingIdentitySagaService.java`](../taurus-be/src/main/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingIdentitySagaService.java), [`taurus-fe/src/app/pages/onboarding/onboarding.component.ts`](../taurus-fe/src/app/pages/onboarding/onboarding.component.ts), [`taurus-fe/src/app/service/onboarding.service.ts`](../taurus-fe/src/app/service/onboarding.service.ts)
- Migrazioni: [`taurus-be/src/main/resources/config/liquibase/changelog/20260905030000_tenant_onboarding_import.xml`](../taurus-be/src/main/resources/config/liquibase/changelog/20260905030000_tenant_onboarding_import.xml)
- Test: [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingTemplateServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingTemplateServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingFileInspectionServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingFileInspectionServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingReportServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingReportServiceTest.java), [`taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingIdentitySagaServiceTest.java`](../taurus-be/src/test/java/com/fundaro/zodiac/taurus/service/onboarding/OnboardingIdentitySagaServiceTest.java), [`taurus-fe/src/app/service/onboarding.service.spec.ts`](../taurus-fe/src/app/service/onboarding.service.spec.ts)
- Note: La migration è inclusa nel master tenant e viene verificata dal plugin Liquibase; i test mirati coprono template, parsing sicuro e reportistica. I test di integrazione end-to-end restano da completare prima di marcare la feature come implementata.
...
- Note: Le migration sono verificate dal plugin Liquibase e i test coprono pianificazione e consumo dei promemoria. Resta da correggere il target dei push calendario, generato come /calendar-events/{id} invece della rotta applicativa /calendar/{id}. La descrizione storica dello stack deve inoltre essere riallineata alle decisioni più recenti su PostgreSQL e consegna delle notifiche.
