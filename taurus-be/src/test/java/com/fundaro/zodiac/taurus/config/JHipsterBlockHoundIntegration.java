...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fundaro.zodiac.taurus.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fundaro.zodiac.taurus.security.DomainUserDetailsService", "createSpringSecurityUser");
