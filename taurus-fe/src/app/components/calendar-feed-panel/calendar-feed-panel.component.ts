...
export class CalendarFeedPanelComponent implements OnInit {
        ...
        this.service
            ...
            .subscribe({
                next: (secret) => {
                    ...
                    this.toast.success('Feed creato', 'Copia ora il link: non sarà più mostrato.');
                    this.load();
                },
    ...
    protected rotate(feed: CalendarFeed): void {
        this.confirm.confirmReversible({
            title: 'Ruota link calendario',
            consequence: 'Il link precedente smetterà subito di funzionare e dovrai aggiornare ogni sottoscrizione.',
            actionLabel: 'Ruota link',
            accept: () => {
                ...
                this.service
                    ...
                    .subscribe({
                        next: (secret) => {
                            ...
                            this.secret = secret;
                            this.toast.success('Link ruotato', 'Copia ora il nuovo link.');
                            this.load();
                        },
