...
public class PdfPageTransform {
    ...
    public double getDeskewDegrees() {
        return deskewDegrees;
    }

    public void setDeskewDegrees(double deskewDegrees) {
        this.deskewDegrees = deskewDegrees;
    }

    public List<PageEditRecipe.Crop> getCrops() {
        return crops;
    }

    public void setCrops(List<PageEditRecipe.Crop> crops) {
        this.crops = crops == null ? List.of() : crops;
    }
