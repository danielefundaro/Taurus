...
export class OperationsWidgetComponent {
    ...
    private readonly allowedTargets: Readonly<Record<OperationalItem['type'], readonly string[]>> = {
        ...
        EVENT_PREPARATION_BLOCKED: ['/calendar?attention=event-preparation'],
        EVENT_PREPARATION_ATTENTION: ['/calendar?attention=event-preparation'],
        EVENT_FOLLOW_UP_REQUIRED: ['/calendar?attention=event-follow-up'],
