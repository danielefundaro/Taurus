...
public class InventoryItem extends TenantAuditedEntity {
    ...
    public BigDecimal getEstimatedUnitValue() {
        return estimatedUnitValue;
    }

    public void setEstimatedUnitValue(BigDecimal estimatedUnitValue) {
    ...
    public UUID getQrPublicId() {
        return qrPublicId;
    }

    public void setQrPublicId(UUID value) {
        qrPublicId = value;
    }
    ...
    public void setQrVersion(int value) {
        qrVersion = value;
    }

    public ZonedDateTime getQrIssuedAt() {
        return qrIssuedAt;
    }

    public void setQrIssuedAt(ZonedDateTime value) {
        qrIssuedAt = value;
    }

    public String getQrIssuedBy() {
        return qrIssuedBy;
    }

    public void setQrIssuedBy(String value) {
        qrIssuedBy = value;
    }
}
