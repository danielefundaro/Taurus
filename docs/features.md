...
| `external-calendar-feed` | [Feed calendario esterno in sola lettura](external-calendar-feed-spec.md) | feature | approved | implemented | BE, FE | [2](#external-calendar-feed-evidenze) | [4](#external-calendar-feed-evidenze) | non rilasciata | 2026-09-05 |
...
| `notification-preferences` | [Preferenze notifiche granulari](notification-preferences-spec.md) | feature | approved | implemented | BE, FE | [2](#notification-preferences-evidenze) | [8](#notification-preferences-evidenze) | non rilasciata | 2026-09-05 |
...
- Note: Fasi 1-5 complete: profilo tipizzato, categorie e snooze, push immediati, silenzioso e digest, console FAILED estesa alle tre origini con retry e chiusura tecnica. Restano attive per scelta le compatibilità della fase contract: doppia lettura della chiave legacy defaultReminderMinutes e booleano push_reminders.sent, da rimuovere dopo un rilascio compatibile.
