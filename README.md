...
- [Runbook di test](docs/runbook-test.md): strategia di qualità, matrici funzionali e di rischio, casi multi-tenant, sicurezza, performance, resilienza e criteri go/no-go;
