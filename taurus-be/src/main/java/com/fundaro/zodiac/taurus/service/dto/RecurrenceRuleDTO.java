...
public class RecurrenceRuleDTO {
    ...
    public List<RecurrenceWeekDay> getWeekDays() {
        return weekDays;
    }

    public void setWeekDays(List<RecurrenceWeekDay> weekDays) {
        this.weekDays = weekDays;
    }

    public RecurrenceEndDTO getEnd() {
        return end;
    }

    public void setEnd(RecurrenceEndDTO end) {
        this.end = end;
    }
}
