...
public class FinancialMovement extends TenantAuditedEntity {
    ...
    public void setEventNameSnapshot(String eventNameSnapshot) {
    ...
    public void setDirection(FinancialDirection direction) {
        this.direction = direction;
    }

    public FinancialMovementNature getNature() {
        return nature;
    }

    public void setNature(FinancialMovementNature nature) {
        this.nature = nature;
    }
