...
public class AccountingYear extends TenantAuditedEntity {
    ...
    public AccountingYearStatus getStatus() {
        return status;
    }

    public void setStatus(AccountingYearStatus status) {
        this.status = status;
    }

    public ZonedDateTime getRolledOverAt() {
        return rolledOverAt;
    }

    public void setRolledOverAt(ZonedDateTime rolledOverAt) {
    ...
    public ZonedDateTime getLastRecalculatedAt() {
        return lastRecalculatedAt;
    }

    public void setLastRecalculatedAt(ZonedDateTime lastRecalculatedAt) {
