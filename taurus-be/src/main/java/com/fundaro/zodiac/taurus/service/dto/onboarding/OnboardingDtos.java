...
public final class OnboardingDtos {
    ...
    public record Row(Long id, OnboardingSection section, int rowNumber, OnboardingRowStatus status,
                      OnboardingRowAction action, Map<String, Object> values) {
    }

    public record Issue(Long id, OnboardingIssueSeverity severity, String code, OnboardingSection section,
                        Integer rowNumber, String columnName, String message, String suggestion) {
    }
