...
public class CalendarEventMaterial extends TenantAuditedEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY, optional = false) @JoinColumn(name = "item_id", nullable = false)
    private InventoryItem item;
    @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "assignment_id")
    private InventoryAssignment assignment;
    @Column(name = "display_order", nullable = false) private int displayOrder;
    @Column(name = "required_quantity", nullable = false) private int requiredQuantity;
    @Column(name = "notes", length = 2000) private String notes;
    @Column(name = "confirmation_hash", length = 64) private String confirmationHash;
    @Column(name = "confirmation_at") private ZonedDateTime confirmationAt;
    @Column(name = "confirmation_by") private String confirmationBy;
    ...
    public void setRequiredQuantity(int value) { requiredQuantity = value; }
    public String getNotes() { return notes; }
    public void setNotes(String value) { notes = value; }
    public String getConfirmationHash() { return confirmationHash; }
    public void setConfirmationHash(String value) { confirmationHash = value; }
    public ZonedDateTime getConfirmationAt() { return confirmationAt; }
    public void setConfirmationAt(ZonedDateTime value) { confirmationAt = value; }
    public String getConfirmationBy() { return confirmationBy; }
    public void setConfirmationBy(String value) { confirmationBy = value; }
}
