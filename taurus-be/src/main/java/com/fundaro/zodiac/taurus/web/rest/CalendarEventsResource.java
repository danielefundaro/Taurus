...
public class CalendarEventsResource extends CommonOpenSearchResource<CalendarEvents, CalendarEventsDTO, CalendarEventsCriteria, CalendarEventsService> {
    ...
    public ResponseEntity<CalendarEventsDTO> setPresentUsers(@PathVariable("id") String id, @RequestBody List<EventPresentUserDTO> presentUsers, AbstractAuthenticationToken token) {
