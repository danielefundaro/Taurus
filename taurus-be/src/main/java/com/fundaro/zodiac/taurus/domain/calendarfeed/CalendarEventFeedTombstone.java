...
public class CalendarEventFeedTombstone {
    ...
    private CalendarFeedAudience audience;
    @Column(nullable = false)
    private int sequence;
    @Column(name = "original_start_date", nullable = false)
    private Instant originalStartDate;
    @Column(name = "original_end_date", nullable = false)
    private Instant originalEndDate;
    @Column(name = "summary_snapshot", nullable = false, length = 255)
    ...
    public void setEventUid(UUID v) {
        eventUid = v;
    }

    public CalendarFeedAudience getAudience() {
        return audience;
    }

    public void setAudience(CalendarFeedAudience v) {
        audience = v;
    }
    ...
    public Instant getOriginalStartDate() {
        return originalStartDate;
    }

    public void setOriginalStartDate(Instant v) {
        originalStartDate = v;
    }

    public Instant getOriginalEndDate() {
        return originalEndDate;
    }

    public void setOriginalEndDate(Instant v) {
        originalEndDate = v;
    }
    ...
    public void setSummarySnapshot(String v) {
        summarySnapshot = v;
    }
    ...
    public void setCancelledAt(Instant v) {
        cancelledAt = v;
    }
